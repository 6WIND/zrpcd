...
extern void zrpc_transport_check_response(struct zrpc_bgp_updater_client *updater, gboolean response);
extern void zrpc_transport_cancel_monitor(struct zrpc_bgp_updater_client *updater);

static bool zrpc_bgp_updater_handle_response(struct zrpc_bgp_updater_client *updater,
                                             bool *response,
                                             GError **perror,
                                             const char *name)
{
        ...
        if (error && error->domain == THRIFT_TRANSPORT_ERROR &&
            error->code == THRIFT_TRANSPORT_ERROR_SEND)
          {
            ...
            if (errno == EAGAIN || errno == EWOULDBLOCK) {
              int fd = zrpc_vpnservice_get_bgp_updater_socket(updater);
              fd_set wrfds;
              struct timeval tout;
              ...
              updater->bgp_updater_select_in_progress = TRUE;
              optval = 0;
              ...
              if (need_reset)
                {
                  ...
                  updater->bgp_updater_select_in_progress = FALSE;
...
static bool zrpc_bgp_updater_wait_reply (struct zrpc_bgp_updater_client *updater,
                                         const char *name)
{
    int fd = zrpc_vpnservice_get_bgp_updater_socket(updater);
    fd_set rdfds;
...
zrpc_bgp_updater_on_update_push_route (struct zrpc_bgp_updater_client *updater, const gchar * rd, const gchar * prefix, const gint32 prefixlen,
#else
zrpc_bgp_updater_on_update_push_route (struct zrpc_bgp_updater_client *updater, const protocol_type p_type, const gchar * rd, const gchar * prefix, const gint32 prefixlen, 
                                       ...
                                       const gchar * gatewayIp, const af_afi afi)
{
  ...
  if(!updater || !updater->bgp_updater_client)
      return FALSE;

#if !defined(HAVE_THRIFT_V6)
  for (thrift_tries = 0; thrift_tries < 2; thrift_tries++) {
#if defined(HAVE_THRIFT_V1)
    response = bgp_updater_client_send_on_update_push_route(updater->bgp_updater_client, rd, prefix, prefixlen, nexthop,
                                                            l3label, &error);
#else
    response = bgp_updater_client_send_on_update_push_route(updater->bgp_updater_client, p_type,
...
#endif /* HAVE_THRIFT_V1 */
    if (zrpc_bgp_updater_handle_response(updater, (bool *)&response, &error, "onUpdatePushRoute()") == FALSE)
      break;
    error = NULL;
  }
#else /* HAVE_THRIFT_V6 */
  ...
  if (response == FALSE)
    ...
    {
      if (zrpc_bgp_updater_wait_reply(updater, "onUpdatePushRoute()"))
        {
          response = bgp_updater_client_recv_on_update_push_route(updater->bgp_updater_client, &_return, &error);
          if (error)
            {
...
gboolean
#if defined(HAVE_THRIFT_V1)
zrpc_bgp_updater_on_update_withdraw_route (struct zrpc_bgp_updater_client *updater, const gchar * rd, const gchar * prefix, const gint32 prefixlen,
#else
zrpc_bgp_updater_on_update_withdraw_route (struct zrpc_bgp_updater_client *updater, const protocol_type p_type, const gchar * rd, const gchar * prefix, const gint32 prefixlen, 
#endif /* HAVE_THRIFT_V1 */
                                           ...
                                           const gint32 l3label, const gint32 l2label, const af_afi afi)
{
  ...
  for (thrift_tries = 0; thrift_tries < 2; thrift_tries++) {
#if defined(HAVE_THRIFT_V1)
    response = bgp_updater_client_on_update_withdraw_route(updater->bgp_updater_client, rd, prefix,
                                                           prefixlen, nexthop, l3label, &error);
#else
    response = bgp_updater_client_on_update_withdraw_route(updater->bgp_updater_client, p_type,
                                                           rd, prefix, prefixlen, nexthop, ethtag, esi, macaddress,
#if defined(HAVE_THRIFT_V2)
...
#endif /* HAVE_THRIFT_V2 */
#endif /* HAVE_THRIFT_V1 */
    if (zrpc_bgp_updater_handle_response(updater, (bool *)&response, &error, "onUpdateWithdrawRoute()") == FALSE)
      break;
    error = NULL;
  }
#else /* HAVE_THRIFT_V6 */
  response = bgp_updater_client_send_on_update_withdraw_route(updater->bgp_updater_client, p_type,
                                                              rd, prefix, prefixlen, nexthop, ethtag, esi, macaddress,
                                                              l3label, l2label, afi, &error);
  if (response == FALSE)
    {
    ...
    {
      if (zrpc_bgp_updater_wait_reply(updater, "onUpdateWithdrawRoute()"))
        {
          response = bgp_updater_client_recv_on_update_withdraw_route(updater->bgp_updater_client, &_return, &error);
          if (error)
            {
...
#if !defined(HAVE_THRIFT_V6)
  for (thrift_tries = 0; thrift_tries < 2; thrift_tries++) {
    response = bgp_updater_client_on_start_config_resync_notification(updater->bgp_updater_client, &error);
    if (zrpc_bgp_updater_handle_response(updater, (bool *)&response, &error, "onStartConfigResyncNotification()") == FALSE)
      break;
    error = NULL;
  }
#else /* HAVE_THRIFT_V6 */
  response = bgp_updater_client_send_on_start_config_resync_notification(updater->bgp_updater_client, &error);
  if (response == FALSE)
    {
      g_error_free (error);
      error = NULL;
    ...
    {
      if (zrpc_bgp_updater_wait_reply(updater, "onStartConfigResyncNotification()"))
        {
          response = bgp_updater_client_recv_on_start_config_resync_notification(updater->bgp_updater_client, &_return, &error);
          if (error)
            {
...
{
  struct zrpc_bgp_updater_client *updater = NULL;
  static gboolean client_ready;

  updater = THREAD_ARG (thread);
  assert (updater);
  if((updater->bgp_updater_client == NULL) ||
     (updater->zrpc_transport_current_status == ZRPC_TO_SDN_UNKNOWN) ||
     (updater->zrpc_transport_current_status == ZRPC_TO_SDN_FALSE))
    {
      if (updater->bgp_updater_client)
        {
          zrpc_vpnservice_terminate_thrift_bgp_updater_client (updater);
        }
      /* start the retry mechanism */
      client_ready = zrpc_vpnservice_setup_thrift_bgp_updater_client(updater);
 ...
 */
gboolean
zrpc_bgp_updater_on_notification_send_event (struct zrpc_bgp_updater_client *updater, const gchar * prefix, const gint8 errCode, const gint8 errSubcode)
{
  GError *error = NULL;
  gboolean response;
#if !defined(HAVE_THRIFT_V6)
...
#if !defined(HAVE_THRIFT_V6)
  for (thrift_tries = 0; thrift_tries < 2; thrift_tries++) {
    response = bgp_updater_client_on_notification_send_event(updater->bgp_updater_client, \
                                                             prefix, errCode, errSubcode, &error); 
    if (zrpc_bgp_updater_handle_response(updater, (bool *)&response, &error, "onNotificationSendEvent()") == FALSE)
      break;
    error = NULL;
  }
#else /* HAVE_THRIFT_V6 */
  response = bgp_updater_client_send_on_notification_send_event(updater->bgp_updater_client, \
                                                                prefix, errCode, errSubcode, &error);
  if (response == FALSE)
    {
      g_error_free (error);
    ...
    {
      if (zrpc_bgp_updater_wait_reply(updater, "onNotificationSendEvent()"))
        {
          response = bgp_updater_client_recv_on_notification_send_event(updater->bgp_updater_client, &_return, &error);
          if (error)
            {
...
#if !defined(HAVE_THRIFT_V6)
  for (thrift_tries = 0; thrift_tries < 2; thrift_tries++) {
    response = bgp_updater_client_peer_up(updater->bgp_updater_client,
                                          ipAddress, asNumber, &error);
    if (zrpc_bgp_updater_handle_response(updater, (bool *)&response, &error, "peerUp()") == FALSE)
      break;
    error = NULL;
  }
#else /* HAVE_THRIFT_V6 */
  response = bgp_updater_client_send_peer_up(updater->bgp_updater_client,
                                             ipAddress, asNumber, &error);
  if (response == FALSE)
    {
      g_error_free (error);
    ...
    {
      if (zrpc_bgp_updater_wait_reply(updater, "peerUp()"))
        {
          response = bgp_updater_client_recv_peer_up(updater->bgp_updater_client, &_return, &error);
          if (error)
            {
...
#if !defined(HAVE_THRIFT_V6)
  for (thrift_tries = 0; thrift_tries < 2; thrift_tries++) {
    response = bgp_updater_client_peer_down(updater->bgp_updater_client,
                                            ipAddress, asNumber, &error);
    if (zrpc_bgp_updater_handle_response(updater, (bool *)&response, &error, "peerDown()") == FALSE)
      break;
    error = NULL;
  }
#else /* HAVE_THRIFT_V6 */
  response = bgp_updater_client_send_peer_down(updater->bgp_updater_client,
                                               ipAddress, asNumber, &error);
  if (response == FALSE)
    {
      g_error_free (error);
    ...
    {
      if (zrpc_bgp_updater_wait_reply(updater, "peerDown()"))
        {
          response = bgp_updater_client_recv_peer_down(updater->bgp_updater_client, &_return, &error);
          if (error)
            {
                                        ...
                                        const gboolean singleActiveMode)
{
...
#if !defined(HAVE_THRIFT_V6)
  for (thrift_tries = 0; thrift_tries < 2; thrift_tries++) {
    response = bgp_updater_client_send_on_update_push_evpn_r_t(updater->bgp_updater_client,
                                                               routeType, rd,
                                                               esi, evi, tunnelType,
                                                               tunnelId, label,
                                                               singleActiveMode, &error);
    if (zrpc_bgp_updater_handle_response(updater, (bool *)&response, &error, "onUpdatePushEvpnRT()") == FALSE)
      break;
    error = NULL;
  }
#else /* HAVE_THRIFT_V6 */
  ...
  if (response == FALSE)
    ...
    {
      if (zrpc_bgp_updater_wait_reply(updater, "onUpdatePushEvpnRT()"))
        {
          response = bgp_updater_client_recv_on_update_push_evpn_r_t(updater->bgp_updater_client, &_return, &error);
          if (error)
            {
                                            ...
                                            const gboolean singleActiveMode)
{
...
#if !defined(HAVE_THRIFT_V6)
  for (thrift_tries = 0; thrift_tries < 2; thrift_tries++) {
    response = bgp_updater_client_send_on_update_withdraw_evpn_r_t(updater->bgp_updater_client,
                                                                   routeType, rd,
                                                                   esi, evi, tunnelType,
                                                                   tunnelId, label,
                                                                   singleActiveMode, &error);
    if (zrpc_bgp_updater_handle_response(updater, (bool *)&response, &error, "onUpdateWithdrawEvpnRT()") == FALSE)
      break;
    error = NULL;
  }
#else /* HAVE_THRIFT_V6 */
  ...
  if (response == FALSE)
    ...
    {
      if (zrpc_bgp_updater_wait_reply(updater, "onUpdateWithdrawEvpnRT()"))
        {
          response = bgp_updater_client_recv_on_update_withdraw_evpn_r_t(updater->bgp_updater_client, &_return, &error);
          if (error)
            {
