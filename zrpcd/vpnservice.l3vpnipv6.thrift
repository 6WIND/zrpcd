...
service BgpConfigurator {
     ...
     */
    i32 pushRoute(1:string prefix, 2:string nexthop, 3:string rd, 4:i32 label, 5:af_afi afi),
    /*
     * withdrawRoute:
     * Second argument is either 'rd' (VPNv4) or
     * label (LU) as a string (eg: "2500")
     * Third argument is either ipv4 or ipv6
     */
...
service BgpUpdater {
    ...
    oneway void onUpdateWithdrawRoute(1:string rd, 2:string prefix,
                                      3:i32 prefixlen, 4:string nexthop, 5:af_afi afi),
