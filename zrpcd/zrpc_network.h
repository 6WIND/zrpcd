...
extern void zrpc_client_transport_close(ThriftTransport *transport);
extern gboolean zrpc_client_transport_open (ThriftTransport *transport,
                                            GError **error, gboolean *needselect);
