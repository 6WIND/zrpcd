...
struct _BgpConfiguratorIfInterface
{
  ...
  gboolean (*add_vrf) (BgpConfiguratorIf *iface, gint32* _return, const layer_type l_type, const gchar * rd, const GPtrArray * irts, const GPtrArray * erts, GError **error);
  gboolean (*del_vrf) (BgpConfiguratorIf *iface, gint32* _return, const gchar * rd, GError **error);
  gboolean (*push_route) (BgpConfiguratorIf *iface, gint32* _return, const protocol_type p_type, const gchar * prefix, const gchar * nexthop, const gchar * rd, const gint64 ethtag, const gchar * esi, const gchar * macaddress, const gint32 l3label, const gint32 l2label, const encap_type enc_type, const gchar * routermac, const gchar * gatewayip, const af_afi afi, GError **error);
  gboolean (*withdraw_route) (BgpConfiguratorIf *iface, gint32* _return, const protocol_type p_type, const gchar * prefix, const gchar * rd, const gint64 ethtag, const gchar * esi, const gchar * macaddress, const af_afi afi, GError **error);
  ...
  gboolean (*get_routes) (BgpConfiguratorIf *iface, Routes ** _return, const protocol_type p_type, const gint32 optype, const gint32 winSize, const af_afi afi, GError **error);
...
gboolean bgp_configurator_if_add_vrf (BgpConfiguratorIf *iface, gint32* _return, const layer_type l_type, const gchar * rd, const GPtrArray * irts, const GPtrArray * erts, GError **error);
gboolean bgp_configurator_if_del_vrf (BgpConfiguratorIf *iface, gint32* _return, const gchar * rd, GError **error);
gboolean bgp_configurator_if_push_route (BgpConfiguratorIf *iface, gint32* _return, const protocol_type p_type, const gchar * prefix, const gchar * nexthop, const gchar * rd, const gint64 ethtag, const gchar * esi, const gchar * macaddress, const gint32 l3label, const gint32 l2label, const encap_type enc_type, const gchar * routermac, const gchar * gatewayip, const af_afi afi, GError **error);
gboolean bgp_configurator_if_withdraw_route (BgpConfiguratorIf *iface, gint32* _return, const protocol_type p_type, const gchar * prefix, const gchar * rd, const gint64 ethtag, const gchar * esi, const gchar * macaddress, const af_afi afi, GError **error);
...
gboolean bgp_configurator_if_get_routes (BgpConfiguratorIf *iface, Routes ** _return, const protocol_type p_type, const gint32 optype, const gint32 winSize, const af_afi afi, GError **error);
