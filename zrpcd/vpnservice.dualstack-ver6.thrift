...
enum protocol_type {
 ...
 service BgpUpdater {
   ...
   i32 onUpdatePushEvpnRT (1:i32 routeType, 2:string rd, 3:string esi, 4:i64 evi,
                                   5:pmsi_tunnel_type tunnelType, 6:string tunnelId,
                                   7:i32 label, 8:bool singleActiveMode);
   i32 onUpdateWithdrawEvpnRT (1:i32 routeType, 2:string rd, 3:string esi,4:i64 evi,
                                       5:pmsi_tunnel_type tunnelType, 6:string tunnelId,
                                       7:i32 label, 8:bool singleActiveMode);
